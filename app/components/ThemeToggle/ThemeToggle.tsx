...
const ThemeToggle: FC<ThemeToggleProps> = ({ forMobileMenu = false }): ReactElement => {
    ...
    return (
        <div className={`${forMobileMenu ? "block" : "hidden"} w-14 h-14 md:block`} onClick={changeTheme}>
            <button
            ...
            >
                <img
                    ...
                    className={`w-10 h-10 absolute ${
                        firstRender ? "" : "transition-translate transition-visibility duration-700"
                    } ${
                        theme === Theme.LIGHT
